...
import 'package:day_23/screen/on_bording3.dart';
...
class On_bording2 extends StatelessWidget {
  const On_bording2({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Creare a Task and Assign it to Your Team Members',
                ...
                MaterialButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => On_bording3())));
                  },
                  child: SvgPicture.asset('asset/Slider2.svg'),
                ),
